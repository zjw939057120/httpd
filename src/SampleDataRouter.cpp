...
void SampleDataRouter::Register(hv::HttpService &router) {
    ...
    router.POST("/api/sample_data/insert", SampleDataHandler::insert);
    router.POST("/api/sample_data/update", SampleDataHandler::update);
    router.POST("/api/sample_data/remove/{id}", SampleDataHandler::remove);
